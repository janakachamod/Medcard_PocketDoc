...
import com.assessment3.testone.databinding.ActivityGetprofiledataBinding
...
class getprofiledata : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title="Profile Data"
    ...
    private fun loadDataFromFirebase() {
        ...
        val userRef = database.getReference("Users/Users").child(userId)
                ...
                if (userData != null && userData.containsKey("firstName") && userData.containsKey("address")
                    ...
                    if (userData.containsKey("profileImage")) {
                        ...
                        try {
                            ...
                            // Catch and handle the exception, but don't take any action as the activity is already destroyed.
                        }
                    }
