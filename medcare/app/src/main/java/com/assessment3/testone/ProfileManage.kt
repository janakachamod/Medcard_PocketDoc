...
import com.assessment3.testone.databinding.ActivityProfileManageBinding
...
class ProfileManage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.Submit.setOnClickListener {
            ...
            // First, remove the existing user data
            database.child("Users").child(id).removeValue()
                .addOnSuccessListener {
                    // Next, set the user data again to place it at the top
    ...
    private fun uploadImageToFirebaseStorage(imageUri: Uri) {
        ...
        val imagesRef: StorageReference = storageRef.child("profile_images/${System.currentTimeMillis()}.jpg")
